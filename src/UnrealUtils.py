...
def ImportMeshAndAnimations(meshPath, animDir):
    ...
    importOption.skeletal_mesh_import_data.set_editor_property("ask_t0_ask_ref_pose", True)

    importTask.options = importOption

    unreal.AssetToolsHelpers.get_asset_tools().import_asset_tasks([importTask])

ImportMeshAndAnimations("D:/MayaToUE_Temp/Alex.fbx", "D:/MayaToUE_Temp/animations/")
